...
def inference(render_event, batch_size, face_imgs_path, audio_feat_queue,
    ...
    while True:
        if render_event.is_set():
            ...
            if is_all_silence:
                ...
                img_batch = np.concatenate((img_masked, img_batch),
                                           axis=3) / 255.
                mel_batch = np.reshape(mel_batch,
                                       [len(mel_batch), mel_batch.shape[1],
                                        mel_batch.shape[2], 1])
...
class LipReal:
    def __init__(self, opt):
        ...
        self.render_event, self.batch_size, self.face_imgs_path,
